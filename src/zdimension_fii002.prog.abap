...
FIELD-SYMBOLS: <fs_zdimwsbk> like it_zdimwsbk_tmp,
  ...
  LOOP AT it_out WHERE zdimflag = 'X' AND edit = 'X'.
    ...
    it_bsis_st-hkont = it_bank_st-hkont = p_hkont.
...
<fs_zdimbsbs>-ZDIMCABEL =  it_bsis_st-ZDIMCABEL.
 ...
 loop at it_zdimwsbk_tmp ASSIGNING <fs_zdimwsbk>.
   ...
   "added by d00194 at 090526 for record date
...
FORM frm_f_answer .
 DATA l_answer TYPE c.
  ...
  IF l_answer = '1'.
*   调用余额调节表程序
      SUBMIT zdimension_fii006 WITH p_bukrs = p_bukrs
              WITH p_hkont = p_hkont
...
* allow to select multiple lines
    ...
    CALL METHOD grid1->set_table_for_first_display
         EXPORTING is_variant                    = alv_variant
                   i_save                        = 'A'
                   is_layout        = gs_layout1
                   it_toolbar_excluding         = alv_exclude
         CHANGING  it_outtab        = it_screen_out
