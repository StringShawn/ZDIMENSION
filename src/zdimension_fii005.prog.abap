...
REPORT  ZDIMENSION_FII005 NO STANDARD PAGE HEADING MESSAGE-ID 00.
...
DATA : dt_output LIKE STANDARD TABLE OF output WITH HEADER LINE,
...
"PARAMETERS : p_cabel RADIOBUTTON GROUP rad2.
...
*      -->P_P_HKONT  text
*----------------------------------------------------------------------*
FORM frm_help_hkont  USING    P_P_HKONT like bseg-hkont.
  TABLES t001.
